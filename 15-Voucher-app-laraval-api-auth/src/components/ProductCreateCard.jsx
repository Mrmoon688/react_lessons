...
const ProductCreateCard = () => {
  ...
  const handleCreateProduct = async (data) => {
    /**
     * Sends a POST request to create a new product with the provided data.
     *
     * @param {Object} data - The product data to be sent.
     * @param {string} data.product_name - The name of the product.
     * @param {number} data.price - The price of the product.
     * @param {boolean} data.back_to_product_list - Flag to navigate back to the product list.
     */
