  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4 text-end">
        <button onClick={handleDecreaseQuantity} className="q-sub pointer-events-none group-hover:pointer-events-auto opacity-0 group-hover:opacity-100 -translate-x-6 group-hover:translate-x-0 duration-200 bg-blue-100 text-blue-600 p-1 rounded">
          <svg
      ...
      <td>
        <button
          ...
          className="   duration-200 group-hover:left-3/4 group-hover:opacity-100 opacity-0 translate-x-1 pointer-events-none group-hover:pointer-events-auto left-full top-3  active:scale-75 bg-blue-100 p-2 rounded-lg"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
